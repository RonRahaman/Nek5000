...
c
     ...
     &  pardictkey(68) / 'TEMPERATURE:SOLVER' /
     &  pardictkey(69) / 'TEMPERATURE:RESIDUALTOL' /
     &  pardictkey(70) / 'TEMPERATURE:ABSOLUTETOL' /
     &  pardictkey(71) / 'PROBLEMTYPE:DP0DT' /
     &  pardictkey(72) / 'CVODE' /
     &  pardictkey(73) / 'CVODE:ABSOLUTETOL' /
     &  pardictkey(74) / 'CVODE:RELATIVETOL' /
     &  pardictkey(75) / 'CVODE:STIFF' /
     &  pardictkey(76) / 'CVODE:MODE' /
     &  pardictkey(77) / 'CVODE:PRECONDITIONER' /
     &  pardictkey(78) / 'CVODE:DTMAX' /
     &  pardictkey(79) / 'CVODE:DQJINCREMENTFACTOR' /
     &  pardictkey(80) / 'CVODE:RATIOLNLTOL' /
     &  pardictkey(81) / ':PARVERSION' /
     &  pardictkey(82) / 'MESH:NUMBEROFBCFIELDS' /
     &  pardictkey(83) / 'GENERAL:OPTLEVEL' /
     &  pardictkey(84) / 'GENERAL:LOGLEVEL' /
      end module GLOBAL_PARDICT
