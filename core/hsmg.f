...
c        Sum overlap region (border excluded)
         ...
         call hsmg_schwarz_dssum2(mg_work(i),l,mg_work_size)
         call hsmg_extrude_acc_4(mg_work,enx,eny,enz)
         call hsmg_extrude_acc_5(mg_work,enx,eny,enz)
...
c----------------------------------------------------------------------
      subroutine hsmg_extrude_acc_1(arr1,nx,ny,nz)
      include 'SIZE'
      include 'INPUT'
      integer nx,ny,nz
      real arr1(nx,ny,nz,nelv)
...
!$ACC LOOP VECTOR COLLAPSE(2)
         do k=i0,i1
         do j=i0,i1
            arr1(1,j,k,ie)  = arr1(3,j,k,ie)
            arr1(nx,j,k,ie) = arr1(nx-2,j,k,ie)
         enddo
         enddo
!$ACC LOOP VECTOR COLLAPSE(2)
         do k=i0,i1
         do i=i0,i1
            arr1(i,1,k,ie) = arr1(i,3,k,ie)
            arr1(i,nx,k,ie) = arr1(i,nx-2,k,ie)
         enddo
         enddo
!$ACC LOOP VECTOR COLLAPSE(2)
         do j=i0,i1
         do i=i0,i1
            arr1(i,j,1,ie) = arr1(i,j,3,ie)
            arr1(i,j,nx,ie) = arr1(i,j,nx-2,ie)
         enddo
         enddo
      enddo
!$ACC END PARALLEL
...
c----------------------------------------------------------------------
      subroutine hsmg_extrude_acc_2(arr1,nx,ny,nz)
      include 'SIZE'
      include 'INPUT'
      integer nx,ny,nz
      real arr1(nx,ny,nz,nelv)
...
!$ACC LOOP VECTOR COLLAPSE(2)
         do k=i0,i1
         do j=i0,i1
            arr1(1,j,k,ie)  = arr1(1,j,k,ie) -
     $                        arr1(3,j,k,ie)
            arr1(nx,j,k,ie) = arr1(nx,j,k,ie) -
     $                        arr1(nx-2,j,k,ie)
         enddo
         enddo
!$ACC LOOP VECTOR COLLAPSE(2)
         do k=i0,i1
         do i=i0,i1
            arr1(i,1,k,ie)  = arr1(i,1,k,ie) -
     $                        arr1(i,3,k,ie)
            arr1(i,nx,k,ie) = arr1(i,nx,k,ie) -
     $                        arr1(i,nx-2,k,ie)
         enddo
         enddo
!$ACC LOOP VECTOR COLLAPSE(2)
         do j=i0,i1
         do i=i0,i1
            arr1(i,j,1,ie)  = arr1(i,j,1,ie) -
     $                        arr1(i,j,3,ie)
            arr1(i,j,nx,ie) = arr1(i,j,nx,ie) -
     $                        arr1(i,j,nx-2,ie)
         enddo
         enddo
      enddo
...
c----------------------------------------------------------------------
      subroutine hsmg_extrude_acc_4(arr1,nx,ny,nz)
      include 'SIZE'
      include 'INPUT'
      integer idx2,nx,ny,nz
      real arr1(nx,ny,nz,nelv*2)
...
!$ACC LOOP VECTOR COLLAPSE(2)
         do k=i0,i1
         do j=i0,i1
            arr1(1,j,k,ie+nelv) = arr1(1,j,k,ie+nelv)
     $                          - arr1(1,j,k,ie)
            arr1(nx,j,k,ie+nelv) = arr1(nx,j,k,ie+nelv)
     $                           - arr1(nx,j,k,ie)
         enddo
         enddo
!$ACC END LOOP
...
!$ACC LOOP VECTOR COLLAPSE(2)
         do k=i0,i1
         do i=i0,i1
            arr1(i,1,k,ie+nelv) = arr1(i,1,k,ie+nelv)
     $                          - arr1(i,1,k,ie)
            arr1(i,nx,k,ie+nelv) = arr1(i,nx,k,ie+nelv)
     $                           - arr1(i,nx,k,ie)
         enddo
         enddo
!$ACC END LOOP
...
!$ACC LOOP VECTOR COLLAPSE(2)
         do j=i0,i1
         do i=i0,i1
            arr1(i,j,1,ie+nelv) = arr1(i,j,1,ie+nelv)
     $                          - arr1(i,j,1,ie)
            arr1(i,j,nx,ie+nelv) = arr1(i,j,nx,ie+nelv)
     $                           - arr1(i,j,nx,ie)
         enddo
         enddo
!$ACC END LOOP
...
c----------------------------------------------------------------------
      subroutine hsmg_extrude_acc_5(arr1,nx,ny,nz)
      include 'SIZE'
      include 'INPUT'
      integer idx2,nx,ny,nz
      real arr1(nx,ny,nz,nelv*2)
...
!$ACC LOOP VECTOR COLLAPSE(2)
         do k=i0,i1
         do j=i0,i1
            arr1(3,j,k,ie) = arr1(3,j,k,ie)
     $                     + arr1(1,j,k,ie)
            arr1(nx-2,j,k,ie) = arr1(nx-2,j,k,ie)
     $                        + arr1(nx,j,k,ie)
         enddo
         enddo
!$ACC LOOP VECTOR COLLAPSE(2)
         do k=i0,i1
         do i=i0,i1
            arr1(i,3,k,ie) = arr1(i,3,k,ie)
     $                     + arr1(i,1,k,ie)
            arr1(i,nx-2,k,ie) = arr1(i,nx-2,k,ie)
     $                        + arr1(i,nx,k,ie)
         enddo
         enddo
!$ACC LOOP VECTOR COLLAPSE(2)
         do j=i0,i1
         do i=i0,i1
            arr1(i,j,3,ie) = arr1(i,j,3,ie)
     $                     + arr1(i,j,1,ie)
            arr1(i,j,nx-2,ie) = arr1(i,j,nx-2,ie)
     $                        + arr1(i,j,nx,ie)
         enddo
         enddo
      enddo
